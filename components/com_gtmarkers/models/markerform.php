 ...
 * @since  1.6
 */
class GtmarkersModelMarkerForm extends JModelForm
{
    private $item = null;
    ...
    protected function populateState()
    {
        ...
        {
                $id = Factory::getApplication()->getUserState('com_gtmarkers.edit.marker.id');
        }
        else
        {
                $id = Factory::getApplication()->input->get('id');
                Factory::getApplication()->setUserState('com_gtmarkers.edit.marker.id', $id);
        }
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_gtmarkers.marker', 'markerform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
    ...
    {
        $data = Factory::getApplication()->getUserState('com_gtmarkers.edit.marker.data', array());
    ...
    public function delete($pk)
    {
        $user = Factory::getUser();
            ...
            if (empty($pk))
            {
                    $pk = (int) $this->getState('marker.id');
            }
