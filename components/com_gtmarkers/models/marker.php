 ...
 * @since  1.6
 */
class GtmarkersModelMarker extends JModelItem
{
    public $_item;
	...
	public function getItem($id = null)
	{
		...
		$query = $db->getQuery(true);
                ...
                $query->where($db->quoteName('a.m_alias') . ' = \''.$this->_item->alias.'\'');
                $db->setQuery($query);
                $reviews = $db->loadObjectList();
                $this->_item->reviews = $reviews;  
            return $this->_item;
        }

        public function getItemAjax($id = null)
	{
            if ($this->_item === null)
            {
                $this->_item = false;
		...
		$query = $db->getQuery(true);
                ...
                foreach ($reviews as $review) {
                    $review->modified_by_name = Factory::getUser($review->modified_by)->name;
                }
                $this->_item->reviews = $reviews;  
                header('Content-type: application/json');
                header('Content-Length: ' . strlen(json_encode($this->_item)), true);
                echo json_encode($this->_item);
