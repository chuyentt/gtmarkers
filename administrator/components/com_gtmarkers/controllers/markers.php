 ...
 * @since  1.6
 */
class GtmarkersControllerMarkers extends JControllerAdmin
{
	/**
	 * Method to clone existing Markers
	 *
	 * @return void
	 */
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'marker', $prefix = 'GtmarkersModel', $config = array())
	{
