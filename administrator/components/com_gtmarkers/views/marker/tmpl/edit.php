...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="marker-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_GTMARKERS_TITLE_MARKER', true)); ?>
		<div class="row-fluid">
