...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_gtmarkers&task=reviews.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_gtmarkers&view=reviews'); ?>" method="post"
			...
			<table class="table table-striped" id="reviewList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_GTMARKERS_REVIEWS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_GTMARKERS_REVIEWS_M_ALIAS', 'a.`m_alias`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_GTMARKERS_REVIEWS_TITLE', 'a.`title`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_GTMARKERS_REVIEWS_RATING', 'a.`rating`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_GTMARKERS_REVIEWS_COMMENT', 'a.`comment`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_GTMARKERS_REVIEWS_TIMESTAMP', 'a.`timestamp`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_gtmarkers&task=review.edit&id='.(int) $item->id); ?>">
