 ...
 * @since  1.6
 */
class GtmarkersViewMarkers extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		GtmarkersHelper::addSubmenu('markers');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_GTMARKERS_TITLE_MARKERS'), 'markers.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('markers.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		JHtmlSidebar::setAction('index.php?option=com_gtmarkers&view=markers');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_GTMARKERS_MARKERS_TITLE'),
			'a.`pos`' => JText::_('COM_GTMARKERS_MARKERS_POS'),
			'a.`timestamp`' => JText::_('COM_GTMARKERS_MARKERS_TIMESTAMP'),
		);
	}
